...
map = folium.Map(location=[43.0919269,-116.5368078], zoom_start=5, tiles = "Stamen Terrain")
...
for lt,ln,el,name  in zip(lat,lon,elev,name):
    ...
    ,fill_color=heightColor(el),color = 'grey',fill_opacity = .8))

fgp = folium.FeatureGroup(name = "2005 Population")
